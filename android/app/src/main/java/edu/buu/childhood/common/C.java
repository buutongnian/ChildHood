...
public final class C {
	...
	public static final class def {
		 ...
		 * @note 域名
		 */
		public static final String DOMAIN = "http://123.57.52.135:8080/";
		/**
		 * 2016/7/4
		 * 
		 * @note 错误
	...
	public static final class reg {
		 ...
		 * @note 注册失败
		 */
		public static final String REG_UNSUCCESS = "R003";
	}
	...
	public static final class security {
		 ...
		 * 2016/7/2
		 * 
		 * @note API错误请求，请求URL不包含用户名或不包含APP TOKEN信息
		 */
		 ...
		 * 2016/7/2
		 * 
		 * @note APP端API请求不合法，APP TOKEN验证失败
		 */
		public static final String TOKEN_INCORRECT = "SE04";
	}
	...
	public static final class onekey {
		 ...
		 * @note 加入游戏不成功
		 */
		public static final String JOIN_GAME_UNSUCCESS = "O006";
	}
	...
	public static final class rank {
		 ...
		 * @note 游戏排名查询成功
		 */
		public static final String GAME_RANK_QUERY_SUCCESS = "R000";
		/**
		 * 2016/7/4
		 * 
		 * @note 用户查询排名成功
		 */
		public static final String USER_RANK_QUERY_SUCCESS = "R001";
	}
