...
public class AsyncImageLoader {
     ...
     * @param imageUrl
     */
    public Bitmap loadImage(View view, String imageUrl) {
        // 先从内存中拿
        Bitmap bitmap = getBitmapFromMem(imageUrl);
        if (bitmap != null) {
            return bitmap;
        ...
        // 内存和文件中都没有再从网络下载
        if (!TextUtils.isEmpty(imageUrl)) {
            new ImageDownloadTask(view).execute(imageUrl);
        }
        return null;
    }
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            if (result != null) {
                if (imageView != null) {
                    ...
                    if (view != null && view.getTag() != null && view.getTag().equals(imageUrl)) {
        ...
        private boolean downloadUrlToStream(String urlString, OutputStream outputStream) {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    //in=imageLoaderCallBack.getInputStream(urlConnection);
