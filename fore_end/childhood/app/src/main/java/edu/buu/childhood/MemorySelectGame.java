 ...
 */
public class MemorySelectGame {
    private CallBackPage cbp1;
    private static MemorySelectGame mInstance;
    public static synchronized MemorySelectGame getInstance()
    {
        if (mInstance == null)
        {
            mInstance = new MemorySelectGame();
        }
        return mInstance;
    }
