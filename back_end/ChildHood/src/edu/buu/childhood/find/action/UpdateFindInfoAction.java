...
public class UpdateFindInfoAction extends ActionSupport {
	/**
	 * UpdateFindInfoAction序列化ID
	 */
	private static final long serialVersionUID = -8925461252641555185L;
