...
<head>
<meta charset="utf-8"/>
<title>API文档-我的信息模块-更新家长信息</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="changeParentInf.jsp"><i class="icon-chevron-right"></i> 更新家长信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">更新家长信息</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/changeParentInf.do</code></li>
            </ul>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td style="text-align: left;">fatherTel</td>
                  <td style="text-align: left;">否</td>
                  <td style="text-align: left;">string</td>
                  <td>父亲电话</td>
                </tr>
                <tr>
                  <td style="text-align: left;">motherTel</td>
                  <td style="text-align: left;">否</td>
                  <td style="text-align: left;">string</td>
                  <td>母亲电话</td>
                </tr>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"M004"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        <span class="hljs-string">"M004"</span>
    ]
</span>}</code></pre>
