...
<head>
<meta charset="utf-8"/>
<title>API文档-我的信息模块-更新我的信息</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="changeUserInf.jsp"><i class="icon-chevron-right"></i> 更新我的信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">更新我的信息</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/changeUserInf.do</code></li>
            </ul>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td style="text-align: left;">detailAdress</td>
                  <td style="text-align: left;">否</td>
                  <td style="text-align: left;">string</td>
                  <td>详细地址</td>
                </tr>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"***"</span></span>,
