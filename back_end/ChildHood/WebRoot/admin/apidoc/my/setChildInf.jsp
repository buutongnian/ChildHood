...
<head>
<meta charset="utf-8"/>
<title>API文档-我的信息模块-设置孩子信息</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="setChildInf.jsp"><i class="icon-chevron-right"></i> 设置孩子信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">设置孩子信息</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/setChildInf.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"M008"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        <span class="hljs-string">"M008"</span>
    ]
</span>}</code></pre>
