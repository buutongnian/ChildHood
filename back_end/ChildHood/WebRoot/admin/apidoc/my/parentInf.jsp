...
<head>
<meta charset="utf-8"/>
<title>API文档-我的信息模块-获取家长信息</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="parentInf.jsp"><i class="icon-chevron-right"></i> 获取家长信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">获取家长信息</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/parentInf.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"M003"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        {
            "<span class="hljs-attribute">parentInf</span>": <span class="hljs-value"><span class="hljs-number">2</span></span>,
            "<span class="hljs-attribute">userName</span>": <span class="hljs-value"><span class="hljs-string">"joe"</span></span>,
            "<span class="hljs-attribute">fatherName</span>": <span class="hljs-value"><span class="hljs-string">"xxx"</span></span>,
            "<span class="hljs-attribute">matherName</span>": <span class="hljs-value"><span class="hljs-string">"xxx"</span></span>,
            "<span class="hljs-attribute">fatherTel</span>": <span class="hljs-value"><span class="hljs-string">"1234567890"</span></span>,
            "<span class="hljs-attribute">matherTel</span>": <span class="hljs-value"><span class="hljs-string">"1234567890"</span>
        </span>}
    ]
</span>}</code></pre>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: left;">ParentInf</td>
            ...
            <ul>
              ...
              <li>返回消息为用户家长信息，对应ParentInf类</li>
            </ul>
          </div>
        </div>
        <!-- /block --> 
