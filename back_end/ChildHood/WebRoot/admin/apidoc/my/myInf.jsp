...
<head>
<meta charset="utf-8"/>
<title>API文档-我的信息模块-获取我的信息</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="myInf.jsp"><i class="icon-chevron-right"></i> 获取我的信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">获取我的信息</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/myInf.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"M000"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        {
            ...
            "<span class="hljs-attribute">userPwd</span>": <span class="hljs-value"><span class="hljs-string">"e10adc3949ba59abbe56e057f20f883e"</span></span>,
            "<span class="hljs-attribute">userHeadImage</span>": <span class="hljs-value"><span class="hljs-string">"https://www.childhood.net/avatar/joe_20160704212820.jpg"</span></span>,
            "<span class="hljs-attribute">userNickname</span>": <span class="hljs-value"><span class="hljs-string">"季文健"</span></span>,
            "<span class="hljs-attribute">lastLatitude</span>": <span class="hljs-value"><span class="hljs-number">39.99649</span></span>,
            "<span class="hljs-attribute">lastLongitude</span>": <span class="hljs-value"><span class="hljs-number">116.434373</span></span>,
            ...
            "<span class="hljs-attribute">userRegInf</span>": <span class="hljs-value">{
                "<span class="hljs-attribute">userName</span>": <span class="hljs-value"><span class="hljs-string">"joe"</span></span>,
                "<span class="hljs-attribute">regDate</span>": <span class="hljs-value"><span class="hljs-string">"Jun 19, 2016 9:39:11 AM"</span></span>,
                "<span class="hljs-attribute">regLatitude</span>": <span class="hljs-value"><span class="hljs-number">39.99649</span></span>,
                "<span class="hljs-attribute">regLongitude</span>": <span class="hljs-value"><span class="hljs-number">116.434373</span></span>,
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: left;">userInf</td>
                  <td>用户信息对象</td>
                </tr>
              </tbody>
            </table>
