...
<head>
<meta charset="utf-8"/>
<title>API文档-状态模块-用户请求周围可加入游戏列表</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li> <a href="userCanInvite.jsp"><i class="icon-chevron-right"></i> 用户请求周围可邀请用户列表</a> </li>
        <li class="active"> <a href="gameCanJoin.jsp"><i class="icon-chevron-right"></i> 用户请求周围可加入游戏列表</a> </li>
      </ul>
    </div>
    <!--/span-->
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">用户请求周围可加入游戏列表</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/gameCanJoin.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"C000"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        {
            ...
            "<span class="hljs-attribute">dataList</span>": <span class="hljs-value">[
                {
                    "<span class="hljs-attribute">gameId</span>": <span class="hljs-value"><span class="hljs-number">35</span></span>,
                    "<span class="hljs-attribute">gameCode</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
                    "<span class="hljs-attribute">gameTitle</span>": <span class="hljs-value"><span class="hljs-string">"测试游戏1"</span></span>,
                    "<span class="hljs-attribute">userNickname</span>": <span class="hljs-value"><span class="hljs-string">"欧阳涛"</span></span>,
                    "<span class="hljs-attribute">gameLatitude</span>": <span class="hljs-value"><span class="hljs-number">39.998065</span></span>,
                    "<span class="hljs-attribute">gameLongitude</span>": <span class="hljs-value"><span class="hljs-number">116.435074</span></span>,
                    "<span class="hljs-attribute">gatherPlace</span>": <span class="hljs-value"><span class="hljs-string">"小区中心花园"</span></span>,
                    "<span class="hljs-attribute">customInf</span>": <span class="hljs-value"><span class="hljs-string">"大家快来吧"</span></span>,
                    "<span class="hljs-attribute">customCount</span>": <span class="hljs-value"><span class="hljs-number">12</span></span>,
                    "<span class="hljs-attribute">gameStatus</span>": <span class="hljs-value"><span class="hljs-string">"S000"</span></span>,
                    "<span class="hljs-attribute">distance</span>": <span class="hljs-value"><span class="hljs-number">185</span>
                </span>}
            ]
        </span>}
    ]
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: left;">InfoList
                    <computecanjoin></computecanjoin></td>
                  <td>返回消息</td>
                </tr>
              </tbody>
            </table>
            ...
            <ul>
              ...
              <li>返回信息为附近可加入游戏列表，对应InfoList&lt;computecanjoin&gt;类</li>
            </ul>
          </div>
        </div>
        <!-- /block --> 
