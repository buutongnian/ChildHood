...
<head>
<meta charset="utf-8"/>
<title>API文档-状态模块-匿名用户请求周围小伙伴列表</title>
<!-- Bootstrap -->
  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="amUserList.jsp"><i class="icon-chevron-right"></i> 匿名用户请求周围用户列表</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">匿名用户请求周围小伙伴列表</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/amUserList.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"C002"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        [
            ...
            </span>},
            {
                ...
                "<span class="hljs-attribute">lastLogitude</span>": <span class="hljs-value"><span class="hljs-number">116.435074</span></span>,
            ...
            <ul>
              ...
              <li>返回信息为周围的人坐标及距离信息，用于在地图上动态加载用户图标点，对应List&lt;amuserlist&gt;类
              </li>
            </ul>
          </div>
        </div>
