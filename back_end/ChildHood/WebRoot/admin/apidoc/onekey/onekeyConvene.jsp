  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="onekeyConvene.jsp"><i class="icon-chevron-right"></i> 一键呼唤</a> </li>
        ...
        <li> <a href="changeGameInfo.jsp"><i class="icon-chevron-right"></i> 更改游戏信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">一键呼唤</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/onekeyConvene.do</code></li>
            </ul>
    ...
    <span class="hljs-string">"messageCode"</span>: <span class="hljs-string">"O000"</span>,
    <span class="hljs-string">"messageContent"</span>: [
        <span class="hljs-string">"O000"</span>
    ]
}
或
{
    <span class="hljs-string">"messageCode"</span>: <span class="hljs-string">"O001"</span>,
    <span class="hljs-string">"messageContent"</span>: [
        <span class="hljs-string">"O001"</span>
    ]
}</code></pre>
