...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
          ...
          <li class="active"> <a href="startGame.jsp"><i class="icon-chevron-right"></i> 开始游戏</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">开始游戏</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/startGame.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"O002"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        <span class="hljs-string">"O002"</span>
    ]
</span>}</code></pre>
