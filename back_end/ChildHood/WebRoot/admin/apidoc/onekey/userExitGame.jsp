...
<head>
<meta charset="utf-8"/>
<title>API文档-一键呼唤模块-玩家取消/退出游戏</title>
<!-- Bootstrap -->
...
<body>
			...
			<div class="span3" id="sidebar" role="navigation">
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
					...
					<li><a href="finishGame.jsp"><i class="icon-chevron-right"></i>
							结束游戏</a></li>
					<li class="active"><a href="userExitGame.jsp"><i
				...
				<div class="row-fluid">
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">玩家取消/退出游戏</div>
						</div>
						<div
							style="padding-top:10px;padding-left:16px;padding-right:16px;">
							<p>
								<strong>所属模块：</strong>
							</p>
							<ul>
							...
							<ul>
								<li>退出游戏（游戏参与者，自动判断参与者是取消还是退出）</li>
							</ul>
							<p>
								<strong>请求URL：</strong>
							</p>
							<ul>
								<li><code>http://123.57.52.135:8080/userExitGame.do</code></li>
							</ul>
							<p>
								<strong>请求方式：</strong>
							</p>
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr
										style="color: rgb(255, 255, 255); background-color: rgb(0, 136, 204);">
    ...
    "<span class="hljs-attribute">messageCode</span>": <span
										class="hljs-value"><span class="hljs-string">"O007"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span
										class="hljs-value">[
        <span class="hljs-string">"O007"</span>
    ]
</span>}</code>
							</pre>
							<p>
							...
							<ul>
								...
								<li>请求成功后自动推送用户退出游戏消息到队伍内各用户</li>
							</ul>
						</div>
					</div>
					<!-- /block -->
