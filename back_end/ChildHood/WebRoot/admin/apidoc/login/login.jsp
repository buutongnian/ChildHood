			...
			<div class="span3" id="sidebar" role="navigation">
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
					<li class="active"><a href="login.jsp"><i
							class="icon-chevron-down"></i> 登录及注册模块</a></li>
					<li><a href="login_detail.jsp"><i
							class="icon-chevron-right"></i> 登录请求</a></li>
					<li><a href="register.jsp"><i class="icon-chevron-right"></i>
							注册</a></li>
				</ul>
			</div>
			<!--/span-->
				...
				<div class="row-fluid">
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">登录及注册模块</div>
						</div>
