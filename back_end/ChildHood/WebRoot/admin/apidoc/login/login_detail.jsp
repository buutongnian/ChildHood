  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="login_detail.jsp"><i class="icon-chevron-right"></i> 登录请求</a> </li>
        <li> <a href="register.jsp"><i class="icon-chevron-right"></i> 注册</a> </li>
      </ul>
    </div>
    <!--/span-->
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">登录请求</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/login.do</code></li>
            </ul>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td style="text-align: left;">lastLatitude</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">double</td>
                  <td>登录时纬度</td>
                </tr>
                <tr>
                  <td style="text-align: left;">lastLongtitude</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">double</td>
                  <td>登录时经度</td>
                </tr>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"LS02"</span></span>,
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        <span class="hljs-string">"LSO2"</span>
    ]
</span>}
</code></pre>
