  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        <li class="active"> <a href="login.jsp"><i class="icon-chevron-down"></i> 登录及注册模块</a> </li>
        <li> <a href="login_detail.jsp"><i class="icon-chevron-right"></i> 登录请求</a> </li>
        <li class="active"> <a href="register.jsp"><i class="icon-chevron-right"></i> 注册</a> </li>
      </ul>
    </div>
    <!--/span-->
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          ...
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/register.do</code></li>
            </ul>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td style="text-align: left;">regLatitude</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">double</td>
                  <td>注册时的纬度</td>
                </tr>
                <tr>
                  <td style="text-align: left;">regLongtitude</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">double</td>
                  <td>注册时的经度</td>
                </tr>
                <tr>
                  <td style="text-align: left;">liveCommunity</td>
                  <td style="text-align: left;">是</td>
                ...
                <tr>
                  <td style="text-align: left;">belongingProvince</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">int</td>
                  <td>所属省份</td>
                </tr>
                <tr>
                  <td style="text-align: left;">belongingCity</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">int</td>
                  <td>所属城市</td>
                </tr>
                <tr>
                  <td style="text-align: left;">belongingDistrict</td>
                  <td style="text-align: left;">是</td>
                  <td style="text-align: left;">int</td>
                  <td>所属区县</td>
                </tr>
    ...
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        <span class="hljs-string">"R001"</span>
    ]
</span>}</code></pre>
