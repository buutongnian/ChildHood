  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        ...
        <li class="active"> <a href="getPartnerList.jsp"><i class="icon-chevron-right"></i> 获取童年小伙伴信息</a> </li>
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">获取童年小伙伴信息</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/getPartnerList.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageContent</span>": <span class="hljs-value">[
        {
            ...
            "<span class="hljs-attribute">totalRecords</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
            "<span class="hljs-attribute">totalPage</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td style="text-align: left;">toatlPage</td>
                  <td style="text-align: left;">Int</td>
                  <td>总共有多少页</td>
                </tr>
                <tr>
                  <td style="text-align: left;">dataList</td>
                  <td style="text-align: left;">FindResult</td>
                  <td>童年小伙伴对象</td>
                </tr>
              </tbody>
            </table>
