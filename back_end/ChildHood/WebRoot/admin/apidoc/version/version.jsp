            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar" role="navigation">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
                        <li class="active">
                            <a href="version.jsp"><i class="icon-chevron-down"></i> 版本更新模块</a>
                        </li>
                        <li>
                            <a href="getLeastVersion.jsp"><i class="icon-chevron-right"></i> 获取最新版本</a>
                        </li>
                    </ul>
                </div>
                <!--/span-->
                      ...
                      <div class="row-fluid">
                          ...
                          <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">版本更新模块</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
						              ...
						              <tbody>
						                <tr>
						                  <td>获取最新版本</td>
						                  <td>getLeastVersion</td>
						                  <td>请求该API获取对应终端最新版本号</td>
						                </tr>
						              </tbody>
						            </table>
                                </div>
