  ...
  <div class="row-fluid">
    <div class="span3" id="sidebar" role="navigation">
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
        <li class="active"> <a href="version.jsp"><i class="icon-chevron-down"></i> 版本更新模块</a> </li>
        <li class="active"> <a href="getLeastVersion.jsp"><i class="icon-chevron-right"></i> 获取最新版本</a> </li>
      </ul>
    </div>
    <!--/span-->
      ...
      <div class="row-fluid"> 
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">获取最新版本</div>
          </div>
          <div style="padding-top:10px;padding-left:16px;padding-right:16px;">
            ...
            <ul>
              <li><code>http://123.57.52.135:8080/getLeastVersion.do</code></li>
            </ul>
    ...
    "<span class="hljs-attribute">messageCode</span>": <span class="hljs-value"><span class="hljs-string">"V000"</span></span>,
