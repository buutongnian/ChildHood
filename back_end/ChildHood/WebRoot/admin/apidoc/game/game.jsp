            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar" role="navigation">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse nav">
                        <li class="active">
                            <a href="game.jsp"><i class="icon-chevron-down"></i> 游戏规则模块</a>
                        </li>
                        <li>
                            <a href="gameHead.jsp"><i class="icon-chevron-right"></i> 游戏规则头信息</a>
                        </li>
                        <li>
                            <a href="gameContent.jsp"><i class="icon-chevron-right"></i> 游戏规则内容信息</a>
                        </li>
                    </ul>
                </div>
                <!--/span-->
                                ...
                                <div class="span12">
						              ...
						              <tbody>
						                <tr>
						                  <td>游戏规则头信息</td>
						                  <td>gameHead</td>
						                  <td>获取游戏规则头信息，用于游戏规则列表界面显示</td>
						                </tr>
						                <tr>
						                  <td>获取回童年小伙伴信息</td>
						                  <td>gameContent</td>
						                  <td>获取游戏内容信息，返回HTML文本信息，用于本地构造页面并显示</td>
						                </tr>
						              </tbody>
						            </table>
                                </div>
