		...
		<div class="row-fluid">
			<div class="span3" id="sidebar">
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					<li><a href="index.jsp"><i class="icon-chevron-right"></i>
							概况</a></li>
					<li class="active"><a href="buttons.jsp"><i
							class="icon-chevron-right"></i> Buttons & Icons</a></li>
				</ul>
			</div>
			<!--/span-->
							...
							<div class="block-content collapse in">
								<div class="span12">
									...
									<div class="well" style="margin-top:30px;">
										<button type="button"
											class="btn btn-large btn-block btn-primary">Block
											level button</button>
										<button type="button" class="btn btn-large btn-block">Block
											level button</button>
									</div>
								</div>
							</div>
						...
						<div class="block">
							...
							<div class="block-content collapse in">
								<div class="span12" style="padding-bottom:30px;">
									...
									<div style="margin-top:10px;">
										<p>This is an example buttons with icons. About 140 icons
											are available.</p>
										<p>
											<button class="btn">
